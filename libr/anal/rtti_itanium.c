...
static void rtti_itanium_print_complete_object_locator_recurse(RVTableContext *context, ut64 atAddress) {
...
R_API void r_anal_rtti_itanium_print_at_vtable(RVTableContext *context, ut64 addr, int mode) {
        rtti_itanium_print_complete_object_locator_recurse (context, addr);
}
